...
public class EmiCalculator {
     ...
     */
    public static Double calculateEmi(Double principal, Double monthlyRate, Integer tenureMonths) {
        ...
        return (principal + principal*monthlyRate*tenureMonths*0.01)/tenureMonths;
    }
